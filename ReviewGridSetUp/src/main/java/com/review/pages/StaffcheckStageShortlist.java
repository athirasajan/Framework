...
public class StaffcheckStageShortlist {
	WebDriver driver;
	...
	public StaffcheckStageShortlist(WebDriver driver){
		this.driver=driver;
	}
	public void StaffCheck() throws Exception{
		...
		Thread.sleep(1000);
		String ED=Utility.getData(3, 1, 0);
		String AE=Utility.getData(4, 1, 0);
		...
		driver.findElement(By.xpath("//*[contains(text(),'Save and proceed')]")).click();
		 ...
		 if(skip==true)
		 {
			...
			System.out.println("tab size"+skipC.size());
			for(WebElement nextSkip:skipC){
				...
				//boolean shortlistButton=driver.findElements(By.xpath("//*[contains(@class,'btn-primary btn_assign_users_com btn-margin-align')]")).size()!=0;
				//if(shortlistButton==true)
				
					// WebElement shortC= driver.findElement(By.xpath("//*[contains(@class,'btn-primary btn_assign_users_com btn-margin-align')]"));
						
					System.out.println("shortlist");
					String Tabname= driver.findElement(By.xpath("//*[contains(@class,'btn-primary btn_assign_users_com btn-margin-align')]//ancestor::div[contains(@id,'action_form_dtls')]/a/h4")).getText();
					 System.out.println(Tabname);
					 switch (Tabname){
					
					 case"Associate Editor":
						System.out.println("Associate Editor tab");
						boolean close = driver.findElements(By.xpath("//*[contains(@class,'search-choice-close')]") ).size() != 0;
						if(close==true)
						{
						driver.findElement(By.xpath("//*[contains(@class,'search-choice-close')]")).click();
						}
						driver.findElement(By.xpath("//div/input[@placeholder='Name']")).sendKeys(AE.trim());
						Thread.sleep(1000);
						driver.findElement(By.name("search_roles")).click();
						Thread.sleep(1000);
						System.out.println("search button");
						driver.findElement(By.xpath("//tr/td/a[contains(text(),'Ms Namitha S')]//ancestor::tr/td/input[@type='checkbox']")).click();
						Thread.sleep(1000);
						driver.findElement(By.name("article-assign-users")).click();
						driver.findElement(By.xpath("//*[contains(@class,'btn-small btn-primary')]")).click();
						Thread.sleep(1000);
						driver.findElement(By.name("next_tab_btn")).click();
		            	break;
	            	...
	            	Thread.sleep(1000);
			       	driver.findElement(By.xpath("//a/h4[text() = '	Editor				']//following::div/input[@placeholder='Name']")).sendKeys(ED.trim());
			       	Thread.sleep(1000);
			       	driver.findElement(By.xpath("//a/h4[text() = '	Editor				']//following::div/button[@name='search_roles']")).click();
			       	Thread.sleep(1000);
	            	driver.findElement(By.xpath("//tr/td/a[contains(text(),'Mr Deepesh S')]//ancestor::tr/td/input[@type='checkbox']")).click();
	            	Thread.sleep(1000);
	            	driver.findElement(By.xpath("//a/h4[text() = '	Editor				']//following::div/button[@name='article-assign-users']")).click();
	            	Thread.sleep(1000);
	            	driver.findElement(By.xpath("//*[contains(@class,'btn-small btn-primary')]")).click();
	            	Thread.sleep(1000);
	            	driver.findElement(By.xpath("//a/h4[text() = '	Editor				']//following::div/button[@name='next_tab_btn']")).click();
	            	break;
		...
		Assert.assertTrue(alertText.contains("Editor Prescreening is assigned to "));
