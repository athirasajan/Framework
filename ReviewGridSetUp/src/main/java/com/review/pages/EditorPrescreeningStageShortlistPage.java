 ...
 *
 */
public class EditorPrescreeningStageShortlistPage {
	...
	public EditorPrescreeningStageShortlistPage(WebDriver driver){
		this.driver=driver;
	}
	public void editorPrescreening() throws Exception{
	   ...
	   /*	List<WebElement> allFormChildElements5 = driver.findElements(By.xpath("//*[contains(@id,'_group_element_')]/div/span[1]"));
		...
		Assert.assertTrue(alertText.contains("AE Prescreening is assigned to"));
