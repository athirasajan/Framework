 ...
 *
 */
public class FinaliseDecisionAcceptstagePage {
	WebDriver driver;
	By staff=By.linkText("Staff");
	...
	By okButton2=By.xpath("//*[contains(@class,'btn-primary btn_nxt_stage_details_modal')]");
	 public FinaliseDecisionAcceptstagePage(WebDriver driver){
			this.driver=driver;
		}
	 public void FinaliseDecision() throws Exception{
		 Thread.sleep(2000);
		  ...
		  /* List<WebElement> allFormChildElements5 = formElement.findElements(By.xpath("//input[@type='file']"));
			...
			*/
			...
			driver.findElement(By.xpath("//button[contains(text(),'Move to License Form')]")).click();
			Thread.sleep(1000);
			driver.findElement(yesbutton2).click();
			Thread.sleep(3000);
			driver.findElement(By.className("cmpl_eml_chk_ini")).click();
			Thread.sleep(1000);
			driver.findElement(By.id("auth_proced_complet_mail")).click();
			Thread.sleep(1000);
