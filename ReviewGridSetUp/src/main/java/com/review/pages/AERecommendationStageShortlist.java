 ...
 *
 */
public class AERecommendationStageShortlist {
...
WebDriver driver;
	...
	By okButton2=By.xpath("//*[contains(@class,'btn-primary btn_nxt_stage_details_modal')]");
	 ...
	 public AERecommendationStageShortlist(WebDriver driver){
			this.driver=driver;
		}
	 public void AERecommendation() throws Exception{
		 ...
		 Thread.sleep(1000);
		   ...
		   List<WebElement> allFormChildElements5 = formElement.findElements(By.xpath("//input[@type='file']"));
			...
			driver.findElement(By.xpath("//button[contains(text(),'Move to Editor Decision')]")).click();
			Thread.sleep(1000);
